    ...
    <li className='flex gap-5 items-center justify-between rounded-lg bg-background-secondary px-3 py-2'>
      ...
      <div className='flex'>
        <CustomTippy content='Restore'>
          <button
            className='mr-1 w-7 cursor-pointer rounded-[4px] text-sm text-text-tertiary  hover:bg-text-secondary hover:text-white p-1'
            onClick={onRestore}
          >
        ...
        <CustomTippy content='Delete Permanently'>
          <button
            className='w-7 cursor-pointer rounded-[4px] text-sm text-text-tertiary  hover:bg-text-secondary hover:text-white p-1'
            onClick={onDelete}
          >

...
export function Task({
  ...
  return (
    <li
      className={
        ' grid min-h-[49px]  cursor-pointer grid-cols-[20px_auto_20px] items-center gap-3 rounded-lg  border-b border-zinc-200   px-5 py-2 transition-all duration-500   ' +
    ...
    >
      <div className='flex'>
        <button
          className={
            'cursor-grab absolute text-text-tertiary transition-transform duration-500 ' +

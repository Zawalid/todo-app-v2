      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            key={tab}
            className={
              'relative text-sm font-semibold text-text-secondary before:absolute before:-bottom-[10px] before:left-0 before:h-[2px] before:w-full before:transition-colors before:duration-300 hover:before:bg-text-secondary sm:text-base ' +

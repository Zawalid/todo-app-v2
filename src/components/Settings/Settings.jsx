...
export function Settings({ onClose }) {
  ...
  return (
    <div className='fixed -top-1 left-0 z-[999999] flex h-full w-full items-center justify-center bg-black bg-opacity-25 backdrop-blur-[1px]'>
      <div className='relative flex h-full w-full flex-col gap-12 overflow-hidden rounded-lg bg-background-primary px-5 sm:px-8 py-4 sm:py-6 sm:flex-row md:h-[510px] md:w-3/5'>
        <button

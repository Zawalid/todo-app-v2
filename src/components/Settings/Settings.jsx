...
export function Settings({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <div
        className={`relative flex h-full w-full flex-col overflow-hidden rounded-lg  bg-background-primary transition-transform duration-300  sm:flex-row md:h-[90%] md:w-3/4 

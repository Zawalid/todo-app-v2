...
export function ListAction({
  isOpen, reference, onDelete, onClose, onChangeColor, onOpenRenameInput, onDuplicateList,
}) {
  ...
  return (
    ...
    >
      ...
      <div
        className={'flex flex-wrap items-center gap-2  overflow-hidden transition-[height] duration-300 ' +
